...
```text
Estructura pensada de los datos:
    ...
    └── data/
        ...
        └── taiwan/
            ...
            └── Preprocessed data/
                ...
                └── Train/                       # 6 clases
```
> Instituto de Investigaciones en Matemáticas Aplicadas y en Sistemas, Universidad Nacional Autónoma de México. Septiembre, 2026